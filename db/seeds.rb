...
'Animals' => [[
  ...
  { 'name' => 'Cat Training', 'image'=> 'http://simplycatbreeds.org/images/cat_training2.jpg', 'description' => "Cat training is the process of modifying a domestic cat's behavior for entertainment or companionship purposes." }],'26', 'http://4.bp.blogspot.com/_HEjoNp_qRz8/TRcUkuX0olI/AAAAAAAAGUI/kq2MN4y46UM/s1600/Today%2527s+Cute+Funny+Silly+Animals+Friends+%25283%2529.jpg'],
'Photography' => [[
...
'Sci-Fi & Fantasy' => [[
  { 'name' => 'Harry Potter', 'image' => 'http://cdn.playbuzz.com/cdn/cb1fb205-833f-424d-8ce3-cba8196c15d0/171c8a0a-4b73-4873-bdcd-18d7c4c50e5e.jpg', 'description' => "Harry Potter is a series of seven fantasy novels written by British author J. K. Rowling. The series chronicles the adventures of a young wizard, Harry Potter, the titular character, and his friends Ronald Weasley and Hermione Granger, all of whom are students at Hogwarts School of Witchcraft and Wizardry. The main story arc concerns Harry's quest to overcome the Dark wizard Lord Voldemort, who aims to become immortal, conquer the wizarding world, subjugate non-magical people, and destroy all those who stand in his way, especially Harry Potter." },
