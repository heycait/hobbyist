...
categories = {
'Arts & Crafts' => [['Painting', 'Sculpting', 'Sewing', 'Pottery', 'Basket Making'],'1'],
'Cars & Motorcycles' => [['Vintage Vehicles', 'Maintenance', 'Racing', 'Car Shows'],'3'],
'Education & Learning' => [['Teaching', 'Study Groups', 'SAT Prep'],'6'],
'Fashion & Beauty' => [['Makeup', 'Winter Clothes', 'Shoes', 'Modeling'],'8'],
'Food & Drink' => [['Cooking', 'Wine', 'Beer', 'Pie Eating', 'Food Trucks'],'10'],
'Games' => [['Sardines', 'Taboo', 'Chess', 'Monopoly', 'Sudoku'],'11'],
'Health & Wellbeing' => [['Suppliments', 'Meditation', 'Acupuncture', 'Dieting', 'Sleep'],'14'],
'Language & Ethnic Identity' => [['French', 'Spanish'],'16'],
'Music' => [['Composing', 'Performing', 'Jam Bands', 'Concert Going', 'Listening', 'Marching Band'],'21'],
'Outdoors & Adventure' => [['Hiking', 'Climbing', 'Camping', 'Skydiving', 'Hang Gliding'],'23'],
'Paranormal' => [['Ghost Hunting', 'Alien Spotting', 'Big Foot', 'Loch Ness'],'24'],
'Animals' => [['Dog Training', 'Pets', 'Animal Control', 'Zoology', 'Cat Training'],'26'],
'Photography' => [['Film', 'Digital', 'Black and White', 'Portfolio Building'],'27'],
'Sci-Fi & Fantasy' => [['Harry Potter', 'Star Trek', 'Star Wars', 'LARPing', 'Comics'],'29'],
'Socializing' => [['Drinking', 'Karaoke', 'Team Sports', 'Talking'],'31'],
'Sports & Recreation' => [['Basketball', 'Baseball', 'Football', 'Swimming', 'Soccer', 'Archery', 'Fencing'],'32'],
'Tech' => [['Programming', 'DBC', 'Robots', 'Wearable Tech', 'Computer Building'],'34'],
}
...
categories.each do |cat, params|
  new_cat = Category.create(name: cat, meetup_id: params[1])
